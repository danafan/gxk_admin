<template>
	<div>
		...
		<el-table :data="dataObj.data" border style="width: 100%" align="center" :header-cell-style="{'background':'#f4f4f4'}" :default-sort = "{prop: 'completeTime'}">
			...
			<el-table-column prop="agent_name" label="总代理名称" align="center">
			</el-table-column>
			<el-table-column prop="agent_account" label="总代理账号" align="center">
			</el-table-column>
	...
	export default{
		...
		methods:{
			...
			check(id,type){
				...
				resource.getaGentwithdRawdetail({id:id,type:1}).then(res => {
					if(res.data.code == 1){
